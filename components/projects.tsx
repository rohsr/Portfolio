...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description: "An interactive dashboard built with D3.js and React for data visualization.",
      github: "https://github.com",
      live: "https://example.com",
    },
  ]
        ...
        {projects.map((project, index) => (
          <div key={index} className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="flex space-x-4">
              ...
              <a href={project.live} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-800">
